...
extern "C" {
    ...
    jlong Java_de_datlag_rubyboy_gameboycore_GameboyCore_createInstance(JNIEnv* env, jclass c) {
        return (jlong) new GameboyCoreJni();
    }

    void Java_de_datlag_rubyboy_gameboycore_GameboyCore_release(JNIEnv* env, jclass c, jlong handle) {
        delete (GameboyCoreJni*)handle;
    }

    void Java_de_datlag_rubyboy_gameboycore_GameboyCore_loadRomFromBuffer(JNIEnv* env, jclass c, jlong handle, jbyteArray byte_buffer) {
    ...
    void Java_de_datlag_rubyboy_gameboycore_GameboyCore_update(JNIEnv* env, jclass c, jlong handle, jint steps) {
        auto const core = (GameboyCoreJni*) handle;
        core->update(steps);
    }

    void Java_de_datlag_rubyboy_gameboycore_GameboyCore_registerScanlineCallback(JNIEnv* env, jclass c, jlong handle, jobject object) {
    ...
    void Java_de_datlag_rubyboy_gameboycore_GameboyCore_setJniEnv(JNIEnv* env, jclass c, jlong handle) {
        auto core = (GameboyCoreJni*)handle;
        core->setJniEnv(env);
    }
